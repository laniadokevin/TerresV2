...
namespace Terres.Data.Migrations
{
    ...
    [Migration("20250113035534_InitialSetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Terres.Core.OLD.Entities.Database.BaseLotes", b =>
                {
            ...
            modelBuilder.Entity("Terres.Core.OLD.Entities.Database.JojmaUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Terres.Core.OLD.Entities.Database.Log", b =>
                {
            ...
            modelBuilder.Entity("Terres.Core.OLD.Entities.Database.Lote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Terres.Core.OLD.Entities.Database.TipoLote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Terres.Core.OLD.Entities.Database.JojmaUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Terres.Core.OLD.Entities.Database.Lote", b =>
                {
                    b.HasOne("Terres.Core.OLD.Entities.Database.TipoLote", "TipoLote")
                        .WithMany()
                        .HasForeignKey("TipoLoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Terres.Core.OLD.Entities.Database.JojmaUser", "User")
                        .WithMany("Lotes")
                        .HasForeignKey("UserId");
